// NppPluginBuildEnvironmentApp.cpp : Defines the entry point for the application.
//

#include "stdafx.h"
#include "NppPluginBuildEnvironmentApp.h"
    ...
    _In_ int       nCmdShow)
{
    ...
    LoadString(hInstance, IDC_NPPPLUGINBUILDENVIRONMENTAPP, szWindowClass, MAX_LOADSTRING);
    ...
    hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_NPPPLUGINBUILDENVIRONMENTAPP));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_NPPPLUGINBUILDENVIRONMENTAPP));
    wcex.hCursor = LoadCursor(NULL, IDC_ARROW);
    wcex.hbrBackground = (HBRUSH)(COLOR_WINDOW + 1);
    wcex.lpszMenuName = MAKEINTRESOURCE(IDC_NPPPLUGINBUILDENVIRONMENTAPP);
