...
set VCXPRJ=%1
call D:\Projects\tools\NppPluginTools\lst2rc.bat %VCXPRJ:.vcxproj=Resource.lst%
call D:\Projects\tools\NppPluginTools\rc2hpp.bat %VCXPRJ:.vcxproj=Resource.rc%
call D:\Projects\tools\NppPluginTools\rc2cpp.bat %VCXPRJ:.vcxproj=Resource.rc%
goto :EOF
:ERROR_NO_PRJ
echo ###
