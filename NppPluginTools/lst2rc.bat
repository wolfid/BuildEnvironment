...
echo ### ///////////////////////////////////@file %LSTFILE%.rc
echo ////////////////////////////////////@file %LSTFILE%.rc> "%RCOUT%"
echo ### ///
echo ///>> "%RCOUT%"
echo ### /// Notepad++ Plugin Build Environment Configuration.
echo /// Notepad++ Plugin Build Environment Configuration.>> "%RCOUT%"
echo ### ///
echo ///>> "%RCOUT%"
echo ### /// Generated by: %~n0%~x0 from %~n1%~x1
echo /// Generated by: %~n0%~x0 from %~n1%~x1>> "%RCOUT%"
echo ### ///
echo ///>> "%RCOUT%"
echo ### ///                                                                %day%%month% %year%
echo ///                                                                %day%%month% %year%>> "%RCOUT%"
echo ### ///
echo ///>> "%RCOUT%"
echo ### //////////////////////////////////////////////////////////////////////////////
echo //////////////////////////////////////////////////////////////////////////////>> "%RCOUT%"
...
echo #include "%LSTFILE%.hpp">> "%RCOUT%"
set YINC=20
set XSPC=10
set WCBX=300
set WCBM=140
