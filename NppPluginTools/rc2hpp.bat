...
echo /// Notepad++ Tools Environment Configuration.>> "%HPPOUT%"
echo ### ///
echo ///>> "%HPPOUT%"
echo ### /// Generated by: %~n0%~x0 from %~n1%~x1
echo /// Generated by: %~n0%~x0 from %~n1%~x1>> "%HPPOUT%"
echo ### ///
echo ///>> "%HPPOUT%"
echo ### ///                                                                %day%%month% %year%
echo ///                                                                %day%%month% %year%>> "%HPPOUT%"
echo ### ///
echo ///>> "%HPPOUT%"
echo ### //////////////////////////////////////////////////////////////////////////////
echo //////////////////////////////////////////////////////////////////////////////>> "%HPPOUT%"
call :TOUPPER RCFILE
echo ### #ifndef %RCFILE%_HPP
echo #ifndef %RCFILE%_HPP>> "%HPPOUT%"
echo ### #define %RCFILE%_HPP
echo #define %RCFILE%_HPP>> "%HPPOUT%"
