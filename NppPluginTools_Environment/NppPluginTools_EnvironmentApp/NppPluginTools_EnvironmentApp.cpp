    ...
    _In_ int       nCmdShow)
{
    ...
    LoadString(hInstance, IDC_NPPPLUGINTOOLS_ENVIRONMENTAPP, szWindowClass, MAX_LOADSTRING);
    ...
    hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_NPPPLUGINTOOLS_ENVIRONMENTAPP));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.lpszMenuName = MAKEINTRESOURCE(IDC_NPPPLUGINTOOLS_ENVIRONMENTAPP);
